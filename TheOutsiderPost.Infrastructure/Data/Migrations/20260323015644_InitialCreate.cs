        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostVersionId = table.Column<int>(type: "int", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoritePosts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_PostVersionId_Order",
                table: "ContentBlocks",
                columns: new[] { "PostVersionId", "Order" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_Status_ScheduledPublishAt",
                table: "Posts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoritePosts_PostId_UserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ContentBlocks_PostVersions_PostVersionId",
                table: "ContentBlocks",
                column: "PostVersionId",
